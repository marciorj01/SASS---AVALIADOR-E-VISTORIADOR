...
import { todayISO, uid, type ChecklistCondition, type ChecklistRoom, type Inspection, type InspectionChecklist, type ComparisonColumn } from "../lib/store";
...
export default function Checklist({ inspection, value, onChange, comparisonColumns = [] }: { inspection: Inspection; value?: InspectionChecklist; onChange: (next: InspectionChecklist) => void; comparisonColumns?: ComparisonColumn[] }) {
